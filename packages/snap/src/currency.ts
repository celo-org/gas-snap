...
export function getFeeCurrencyNameFromAddress(feeCurrencyAddress: string | undefined, network: string): string {
    switch (network) {
        case CELO_ALFAJORES:
  ...
  export function getFeeCurrencyAddressFromName(feeCurrencyName: string, network: string): string | undefined {
    switch (network) {
      case CELO_ALFAJORES:
 ...
 * feeCurrency is Celo. 
 */
export async function getOptimalFeeCurrency(tx: CeloTransactionRequest, wallet: CeloWallet): Promise<string | undefined> {
